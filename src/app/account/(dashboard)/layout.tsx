  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <nav className="mb-8 flex gap-6 border-b border-line text-sm font-medium text-ink-600">
          <Link href="/account" className="pb-3 hover:text-ink-900">
            Profile
          </Link>
          <Link href="/account/orders" className="pb-3 hover:text-ink-900">
            Orders
          </Link>
          <Link href="/account/support" className="pb-3 hover:text-ink-900">
            Support
          </Link>
        </nav>
        {children}
